...
export BENCH_GDR_ITERS=${BENCH_GDR_ITERS:-$BENCH_ITERS}
export BENCH_GDR_WARMUP=${BENCH_GDR_WARMUP:-$BENCH_WARMUP}
export BENCH_NCCL_ITERS=${BENCH_NCCL_ITERS:-$BENCH_ITERS}
export BENCH_NCCL_WARMUP=${BENCH_NCCL_WARMUP:-$BENCH_WARMUP}
