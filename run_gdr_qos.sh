...
DEFAULT_BENCH_GDR_ITERS=10
DEFAULT_BENCH_GDR_WARMUP=100
DEFAULT_BENCH_NCCL_ITERS=10
DEFAULT_BENCH_NCCL_WARMUP=100
...
export BENCH_NCCL_WARMUP=${BENCH_NCCL_WARMUP:-$DEFAULT_BENCH_NCCL_WARMUP}
export BENCH_ITERS=${BENCH_ITERS:-$BENCH_NCCL_ITERS}
export BENCH_WARMUP=${BENCH_WARMUP:-$BENCH_NCCL_WARMUP}
